    ...
    while (read (fd, &abuffer, sizeof (auxv_t))) {
        switch (abuffer.a_type) {
            ...
            case AT_EXECFD:
                ...
                break;
            case AT_PHDR:
                printf ("Program headers for program: %u\n", abuffer.a_un.a_val);
                break;
            case AT_PHENT:
            ...
            case AT_PHNUM:
                ...
                break;
            case AT_PAGESZ:
                printf ("System page size: 0x%x\n", abuffer.a_un.a_val);
                break;
            case AT_BASE:
                printf ("Interpreter base address: 0x%lx\n", abuffer.a_un.a_ptr);
                break;
            case AT_FLAGS:
                printf ("Flags: %u\n", abuffer.a_un.a_val);
                break;
            ...
            case AT_EGID:
                ...
                break;
            case AT_CLKTCK:
                printf ("Frequently of times: %f\n", (float)abuffer.a_un.a_val);
                break;
            case AT_PLATFORM:
                printf ("Plataform string id: %s\n", (char*)abuffer.a_un.a_ptr);
                break;
            case AT_HWCAP:
                printf ("Machine dependent hints about processor capabilities value: 0x%x\n", abuffer.a_un.a_val);
                break;
            case AT_FPUCW:
                printf ("FPU informations:\n\t0x%u\n\t%lu\n\t0x%lu", abuffer.a_un.a_val, abuffer.a_un.a_ptr, abuffer.a_un.a_fcn);
                break;
            case AT_DCACHEBSIZE:
                printf ("Data cache block size: 0x%u", abuffer.a_un.a_val);
                break;
            case AT_ICACHEBSIZE:
                printf ("Instruction cache block size: 0x%u", abuffer.a_un.a_val);
                break;
            case AT_UCACHEBSIZE:
                printf ("Unified cache block size: 0x%u", abuffer.a_un.a_val);
                break;
            default:
                //puts ("Undefined flag");
        }
